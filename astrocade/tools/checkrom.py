...
Vendored from fujinet-firmware/pico/astrocade/tools/checkrom.py. Enforces
the layout contract in fuji_mailbox.h so a client that drifts into the
mailbox pages fails its build, not a debugging session:
  - exactly 8192 bytes;
